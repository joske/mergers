...
This downloads a pre-built binary and pulls in GTK4 and GtkSourceView 5 automatically.

### Linux (AppImage)

Download the latest AppImage from [GitHub Releases](https://github.com/joske/mergers/releases):
